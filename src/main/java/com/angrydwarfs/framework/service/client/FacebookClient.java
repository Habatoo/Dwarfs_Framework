...
public class FacebookClient {
    ...
    public FacebookUser getUser(String accessToken) {
        final String path = "/me?fields={fields}&redirect={redirect}&access_token={access_token}";
        final String fields = "email,first_name,last_name,id,picture.width(720).height(720)";
